...
import { X, Heart, Share2, ShoppingCart, Star, Plus, Minus, Truck, Shield, RotateCcw, Eye, ZoomIn, ChevronLeft, ChevronRight, MapPin, Clock, Award, Users, MessageCircle } from 'lucide-react';
